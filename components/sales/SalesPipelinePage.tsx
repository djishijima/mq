            ...
            {COLUMNS_ORDER.map(status => (
                ...
                >
                    <div className="flex justify-between items-center mb-4 px-1 flex-shrink-0">
                        ...
                        <span className="text-sm font-bold bg-slate-200 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded-full">{jobsByStatus[status].length}</span>
                    </div>
