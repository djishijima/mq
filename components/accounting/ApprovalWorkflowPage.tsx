...
import { ApplicationWithDetails, ApplicationCode, User, Toast, Page } from '../../types';
...
const ApprovalWorkflowPage: React.FC<ApprovalWorkflowPageProps> = ({ currentUser, view, formCode, searchTerm, addToast, onNavigate }) => {
    // State for list view
